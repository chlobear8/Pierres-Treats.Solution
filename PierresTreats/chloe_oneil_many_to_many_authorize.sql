...
--
-- Host: localhost    Database: chloe_oneil_many_to_many_authorize
-- ------------------------------------------------------
...
CREATE TABLE `flavors` (
  ...
  KEY `FK_Test_idx` (`UserId`),
  CONSTRAINT `FK_Test` FOREIGN KEY (`UserId`) REFERENCES `aspnetusers` (`Id`)
...
CREATE TABLE `treats` (
  ...
  CONSTRAINT `FK_USER_ID` FOREIGN KEY (`UserId`) REFERENCES `aspnetusers` (`Id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2023-04-08 15:35:16
